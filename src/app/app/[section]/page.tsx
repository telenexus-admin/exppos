...
const sections=new Set(["branches","staff","customers","products","inventory","purchases","sales","invoices","accounting","expenses","reports","tasks","audit-logs","settings","notifications"]);
