...
- `/api/v1/operator/*` — platform operator context
- `/api/v1/app/*` — tenant admin and permission-bearing tenant users
- `/api/v1/staff/*` — role-shaped staff experiences backed by the same services
