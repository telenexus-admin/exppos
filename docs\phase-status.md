...
This repository implements a secure production-oriented MVP foundation across all eight requested domains. â€œImplementedâ€ means schema and service/API/UI foundations exist; it does not claim every long-tail screen and report variant is finished.
